...
int _main (int argc, char * argv[]) {
    ...
    size_t wbuf_depth    = 2; // write buffer depth
    ...
    segtable.addSegment("seg_kunc" , SEG_KUNC_BASE, SEG_KUNC_SIZE, RAM_INDEX, true );
    ...
    soclib::common::Loader loader("soft/sys.bin", "soft/app.bin");
